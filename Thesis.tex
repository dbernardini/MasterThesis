...
\item check if all the sensors are working properly through the official BiosignalsPlux application (OpenSignals);
...
\item tell the participant not to tell anything about the experience to other people (30 seconds).
...
\item participant can ask the examiner questions about things he did not understand from the tutorial;
